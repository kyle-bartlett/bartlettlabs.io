...
const collectionPaths = [
  {
    ...
    body: "The Widgo chat on the Bartlett Labs website answers questions about our services. It does not collect SMS consent or sign you up for text messages.",
  },
  {
