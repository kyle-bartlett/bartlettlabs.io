          ...
          <div className={styles.heroGrid}>
            <div>
              <span className={styles.kicker}>
                Built for Crosby, TX local operators
              </span>
              <h1 className={styles.h1}>
                AI Automation built for Crosby, TX businesses.
              </h1>
              <p className={styles.lead}>
                Stop letting missed calls go to your competitors. Capture,
                engage, and book local Crosby clients 24/7 with our AI Missed
                Leads Assistant.
              </p>
            ...
            <div className={styles.demoCard}>
              ...
              <div className={styles.demoBubble}>
                Hey, thanks for calling — we&apos;re helping another Crosby
                customer right now. What project can we help you with today?
              </div>
        ...
        <div className={styles.container}>
          <div className={styles.splitGrid}>
            <div>
              ...
              <p className={styles.lead}>
                As a local contractor, builder, realtor, or home service
                provider in Crosby, you&apos;re constantly out in the field.
                When you&apos;re on a job site, showing a property, or driving
                down FM 2100, you can&apos;t always pick up the phone.
              </p>
              <p className={styles.lead}>
                In today&apos;s market, if you don&apos;t answer a prospect
                within 5 minutes, they&apos;ve already called the next local
                business on Google. You&apos;re losing thousands in revenue to
                missed calls.
              </p>
              <div className={styles.calloutBar}>
                <Clock size={20} aria-hidden="true" />
                The first 5 minutes decide whether that lead is yours — or
                someone else&apos;s.
              </div>
            </div>
            ...
            <div className={styles.workdayCard}>
              ...
              <div className={styles.workdayList}>
                ...
                <div className={styles.workdayItem}>
                  <PhoneIncoming size={18} aria-hidden="true" />A new prospect
                  calls from Google
                </div>
                <div className={styles.workdayItem}>
              ...
              <div className={styles.workdayBand}>
                ...
                <div className={styles.workdayBandText}>
                  in potential monthly revenue can disappear from unanswered
                  calls.
                </div>
              </div>
            </div>
      ...
      <section className={`${styles.section} ${styles.sectionLight}`}>
        <div className={styles.container}>
          <div className={styles.sectionHead}>
            ...
            <h2 className={styles.h2}>
              The AI Missed Leads Assistant keeps conversations moving while you
              keep working.
            </h2>
            <p className={styles.lead}>
              A managed system that responds fast, captures the lead, lifts
              local proof, and keeps your team out of complicated tech.
            </p>
          </div>
          <div className={`${styles.cardGrid} ${styles.cardGrid3}`}>
            <article className={styles.card}>
              ...
              <p className={styles.cardText}>
                ...
                prospect back, starts a conversation, and answers their
                questions.
              </p>
            </article>
            <article className={styles.card}>
              ...
              <p className={styles.cardText}>
                Automatically requests and routes Google Reviews from your
                happiest Crosby clients to elevate your local authority.
              </p>
            </article>
            <article className={styles.card}>
              <div className={styles.cardIcon}>
          ...
          <div className={styles.noteBar}>
            ...
            Designed for local teams that need outcomes, not another software
            login.
          </div>
        </div>
      </section>
      ...
      <section className={`${styles.section} ${styles.sectionLight}`}>
        <div className={styles.container}>
          <div className={styles.sectionHead}>
            ...
            <h2 className={styles.h2}>
              Full system typically live within a week, without touching your
              workflow.
            </h2>
          </div>
          <div className={styles.steps}>
            <div className={styles.step}>
              ...
              <p className={styles.stepText}>
                We run your free audit and pinpoint exactly where Crosby leads
                are slipping — missed calls, slow replies, no review flow.
              </p>
            </div>
            <div className={styles.step}>
              ...
              <p className={styles.stepText}>
                We set up the Missed Leads Assistant on your existing number and
                dial in the messaging for your trade and service area.
              </p>
            </div>
            <div className={styles.step}>
              ...
              <p className={styles.stepText}>
                We go live, watch the first real leads come back, and keep
                managing it so you never touch the tech.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className={styles.section}>
        <div className={styles.container}>
          <div className={styles.sectionHead}>
            ...
            <h2 className={styles.h2}>
              Built for Crosby, not a national call center.
            </h2>
            <p className={styles.lead}>
        ...
        <div className={styles.container}>
          <div className={styles.closeWrap}>
            <span className={styles.badge}>
              Crosby community sponsor on Alignable
            </span>
            <h2 className={styles.h2} style={{ marginTop: "1rem" }}>
              Claim one of the first 10 free Crosby AI Opportunity Audits this
              month.
            </h2>
            <p className={styles.lead} style={{ marginInline: "auto" }}>
              We are proud sponsors of the Crosby community on Alignable. To
              help our neighbors scale, we are offering a Free AI Opportunity
              Audit to the first 10 Crosby businesses who sign up this month.
              We&apos;ll show you exactly where your lead leaks are and how to
              patch them.
            </p>
