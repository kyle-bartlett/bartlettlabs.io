...
export const workScreenshotAssets = {
  "santiagos-auto-repair": {
    ...
    alt: "Primary Bartlett Labs concept screenshot for the Redline Auto Repair sample build",
    aspectRatio: "16:10",
    minWidth: 1600,
    minHeight: 1000,
    fit: "contain",
  ...
  "five-stars-electric": {
    ...
    alt: "Primary Bartlett Labs concept screenshot for the Voltline Electric sample build",
    aspectRatio: "16:10",
    minWidth: 1600,
    minHeight: 1000,
    fit: "contain",
  ...
  "doggie-world-grooming": {
    ...
    alt: "Primary Bartlett Labs concept screenshot for the Wagtails Pet Grooming sample build",
    aspectRatio: "16:10",
    minWidth: 1600,
    minHeight: 1000,
    fit: "contain",
  ...
  "lake-houston-fitness": {
    ...
    alt: "Primary Bartlett Labs concept screenshot for the Ironside Fitness sample build",
    aspectRatio: "16:10",
    minWidth: 1600,
    minHeight: 1000,
    fit: "contain",
  ...
  "cycle-landscaping": {
    ...
    alt: "Primary Bartlett Labs concept screenshot for the Greenline Landscaping sample build",
    aspectRatio: "16:10",
    minWidth: 1600,
    minHeight: 1000,
    fit: "contain",
  ...
  "straight-off-the-road-bbq": {
    ...
    alt: "Primary Bartlett Labs concept screenshot for the Backroad BBQ Co. sample build",
    aspectRatio: "16:10",
    minWidth: 1600,
    minHeight: 1000,
    fit: "contain",
